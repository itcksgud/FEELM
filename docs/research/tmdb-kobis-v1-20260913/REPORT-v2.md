...
![관객과 투표 수 및 영화별 비율 분포](data-v2/01-counts-and-ratios.png)
...
![관객 규모별 관측량 불균형](data-v2/02-scale-imbalance.png)
...
![TMDB 평균평점과 관측량](data-v2/03-rating-relations.png)
...
![영화 간 평균 차이와 영화 안 개인별점 차이](data-v2/04-rating-dispersion.png)
...
PNG와 같은 이름의 SVG도 `data-v2/`에 있어 발표에 벡터로 사용할 수 있다.
